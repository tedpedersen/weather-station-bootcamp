...
var getWeather = function(cityname) {
    ...
    fetch(apiUrlToday).then(function(response) {
      response.json().then(function(data2) {
        ...
        var searchHistory = `<li class="list-group-item upper">${city}</li>`;
...
﻿
        ...
        var thewind3 = data.list[24].wind.speed;
        var thehum3 = data.list[24].main.humidity;
        var thetemp3 = data.list[24].main.temp;
        var thecond3 = data.list[24].weather[0].description;
        var iconcode3 = data.list[24].weather[0].icon;
        var iconurl3 = "http://openweathermap.org/img/w/" + iconcode3 + ".png";
        var myDate3 = data.list[24].dt_txt;
